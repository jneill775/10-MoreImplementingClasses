...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        return Line(Point(self.start.x + other_line.start.x, self.start.y + other_line.start.y), Point(other_line.end.x + self.end.x, self.end.y + other_line.end.y))
    ...
    def reset(self):
        ...
        return Line(self.initialend, self.initialstart)
